...
if __name__ == '__main__':
	...
	parser.add_argument('--gpu', type=str, default='0', help='gpn number')
	parser.add_argument('--image', type=str, required=True, help='input image')
	parser.add_argument('--out_path', type=str, default='./result/', help='output image')
